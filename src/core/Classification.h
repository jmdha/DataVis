...
namespace Classification {
    namespace KNN {
        static std::multiset<std::pair<double, int>> GenerateNeighbours(const std::unordered_map<int, std::vector<Series>> &trainData,
                                                                        const Series &series) {
        ...
        static uint Classify(const std::unordered_map<int, std::vector<Series>> &trainData, const Series &series, uint k) {
